...
(function() {
    ...
    settings.prototype.songIntervalMessages = [
      {
        interval: 6,
        offset: 0,
        msg: "/me Stay active in chat while in line. We remove AFK DJ's at the booth!"
      }, {
        interval: 5,
        offset: 0,
      ...
      if (timeSinceLastActivity > data.afkTime) {
        if (user.getIsDj()) {
          ...
          if (user.getWarningCount() === 0) {
            user.warn();
            _results.push(API.sendChat("/me " + "@" + user.getUser().username + ", I haven't seen you chat in about 1 hour. Are you AFK?  If you don't show activity in 4 minutes I will remove you from the booth."));
            ...
            if (timeSinceLastWarning > twoMinutes) {
              ...
              if (DJs.length > 0 && DJs[0].id !== user.getUser().id) {
                API.sendChat("/me " + "@" + user.getUser().username + ", I Have given you 1 warning. Please stay active by chatting.");
  ...
  roomHelpCommand = (function(_super) {
    ...
    roomHelpCommand.prototype.functionality = function() {
      ...
      msg1 = "Welcome to hardstyle-heaven! Create a playlist and populate it with songs from either YouTube or Soundcloud.  ";
  ...
  dieCommand = (function(_super) {
    ...
    dieCommand.prototype.functionality = function() {
      API.sendChat("/me Switching auto AFK-remover off...");
      undoHooks();
      API.sendChat("");
      data.implode();
      return API.sendChat("/me ...auto AFK-remover is now off");
    };
  ...
  reloadCommand = (function(_super) {
    ...
    reloadCommand.prototype.functionality = function() {
      ...
      API.sendChat('/me reloading auto AFK-remover...');
      undoHooks();
