(function () {
    ...
    pupOnline = function () {
        return API.sendChat('/me AFK remover activated')
    };
    ...
    dieCommand = (function (a) {
        ...
        dieCommand.prototype.functionality = function () {
            undoHooks();
            data.implode();
            return API.sendChat('/me AFK remover switching off . . .')
        };
        return dieCommand
    })(Command);
    f = (function (c) {
        ...
        f.prototype.functionality = function () {
            ...
            if (userRemove === false) {
                API.sendChat("I couldn't find that person to ban")
            } else {
    ...
    handleUserJoin = function (a) {
        ...
        return API.sendChat("Welcome to Hardstyle-Heaven  @" + a.username + ", Chat at least once every 60 minutes if you want to stay in the waitlist")
    };
